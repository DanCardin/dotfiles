...
local plugins = {
  ["completion-buffers"] = {
    ...
    only_sequence = false,
    only_setup = false,
    path = "/Users/danc/.local/share/nvim/site/pack/packer/opt/completion-buffers"
  },
  ["git-messenger.vim"] = {
    loaded = false,
    only_sequence = false,
  ...
  ["vim-vsnip"] = {
    ...
    only_sequence = false,
    only_setup = false,
    path = "/Users/danc/.local/share/nvim/site/pack/packer/opt/vim-vsnip"
  },
  ["vim-vsnip-integ"] = {
    loaded = false,
    only_sequence = false,
    only_setup = false,
    path = "/Users/danc/.local/share/nvim/site/pack/packer/opt/vim-vsnip-integ"
  },
  ["vista.vim"] = {
    loaded = false,
    only_sequence = false,
...
augroup packer_load_aucmds
  ...
  " Filetype lazy-loads
  " Event lazy-loads
  au VimEnter * ++once call s:load(['git-messenger.vim'], { "event": "VimEnter *" })
augroup END
